...
class advanceSearchForm(forms.Form):
    ...
    InstituteName = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Institute Name'}), label='Institute',
        max_length=30, required=False)
    courseName = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Course/Class Name'}),
        label='Course/Class',
        max_length=30, required=False)
    Organisation = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Organisation Name'}),
        label='Organisation/Working',
        max_length=30, required=False)
    profile = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Job Profile'}),
                              label='Job Profile',
                              max_length=30, required=False)
    location = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Job Location'}),
                               label='Location',
                               max_length=30, required=False)
...
class SignUpForm(ModelForm):
    ...
    username = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': "Enter Unique Username"}),
        help_text='Required. Minimum 5 characters . Letters, digits and @/./+/-/_ only.', label="Username",
        required=True)
...
class ProfileForm(ModelForm):
    ...
    lname = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter Last Name'}),
...
class LoginForm(ModelForm):
    ...
    password = forms.CharField(
        widget=forms.PasswordInput(
            attrs={'class': 'form-control', 'placeholder': 'provide password assosiated with username'}),
        max_length=35,
        required=True,

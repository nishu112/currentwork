...
urlpatterns = [
    ...
    url(r'^users/profile/(?P<slug>[\w.@+-]+)/ChaneProfileInfo$', login_required(views.UserProfileEdit),
        name='UserProfileEdit'),
    url(r'^users/profile/(?P<slug>[\w.@+-]+)/ChangePassword$', login_required(views.UserChangePassword),
    ...
    url(r'^chat-room/(?P<slug1>[\w.@+-]+)__Messages__(?P<slug2>[\w.@+-]+)/$', login_required(views.Messenger_Chatting),
        name='Messenger'),
    ...
    url(r'^ajax/groups/AdminAddQueueMembers/$', login_required(views.AdminAddQueueMembers),
        name='AdminAddQueueMembers'),
    url(r'^ajax/groups/GroupMemberListActions/$', login_required(views.MemberListActions),
        name='GroupMemberListActions'),
